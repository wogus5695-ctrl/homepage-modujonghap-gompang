            ...
            {dynamic ? (
              <>
                ...
                <span className="text-gray-900 block text-xl font-bold">
                  ...
                  {!dynamic.service.includes("곰팡이제거") && !dynamic.service.includes("단열시공") && !dynamic.service.includes("탄성코트") && !dynamic.service.includes("결로방지") && !dynamic.service.includes("페인트") && "현장 원인에 맞춰 해결합니다"}
                </span>
              </>
            ) : (
              <>
          ...
          <p className="block lg:hidden text-[14px] sm:text-base text-gray-500 mb-8 leading-relaxed font-medium max-w-md mx-auto text-center break-keep [word-break:keep-all]">
            {dynamic ? (
              <>
                ...
                {!dynamic.service.includes("곰팡이제거") && !dynamic.service.includes("단열시공") && !dynamic.service.includes("탄성코트") && !dynamic.service.includes("결로방지") && !dynamic.service.includes("페인트") && "모든 현장은 저마다 다른 원인을 가지고 있습니다. 전문가의 꼼꼼한 진단과 시공으로 공간의 쾌적함을 되찾아 드립니다."}
              </>
            ) : (
              <>
